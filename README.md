...
linux-3.5.4_R_x86_32_FDLIST(测试用linux3.5.4test)

linux-3.8_R_x86_32_FDLIST(测试用linux3.8test)
...
linux-3.8_R_x86_32_SOLIST

linux-3.8_R_x86_32_SOLIST5

linux-3.8_R_x86_32_DOLIST
...
运行ruby cpath.rb rpath diffpath_linux-3.5.4_linux-3.8（ruby cpath.rb rpath 存入差异数据库表diffpath_linux-3.5.4_linux-3.8）
...
### 四、获取有差异的函数名，并存入路径
运行ruby rfile.rb linux3.8test diff_linux-3.5.4_linux-3.8（ruby rfile.rb 比较的版本1的函数定义列表 存入差异数据库表diff_linux-3.5.4_linux-3.8）

运行ruby wsql.rb linux3.5.4test diff_linux-3.5.4_linux-3.8（ruby wsql.rb 比较的版本2的函数定义列表 存入差异数据库表diff_linux-3.5.4_linux-3.8）
